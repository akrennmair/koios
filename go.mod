module github.com/akrennmair/koios

go 1.18

require (
	github.com/akrennmair/go-athena v0.3.0
...
require (
	github.com/antlr/antlr4/runtime/Go/antlr v0.0.0-20211207165212-ceac269f1a1a // indirect
